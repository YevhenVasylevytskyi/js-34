...
const getSortedFriends = users => {
    ...
    const uniqueFriends = nameFriends.filter((value, index, friends) => nameFriends.indexOf(value) === index);
    const sortUniqueFriends = uniqueFriends.sort((firstName, secondName) => firstName.localeCompare(secondName));
    return sortUniqueFriends;
};
